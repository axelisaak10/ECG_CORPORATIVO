      ...
      <div className="bg-white rounded-3xl p-8 md:p-12 shadow-2xl">
        ...
        <div className="grid md:grid-cols-2 gap-12">
          ...
          <form onSubmit={handleSubmit} className="space-y-4">
            ...
            <button
              type="submit"
              className={`w-full py-4 rounded-xl text-white font-bold flex items-center justify-center gap-2 transform hover:scale-[1.02] active:scale-95 transition-all shadow-lg ${accent.bg} ${accent.hover}`}
            >
              <Send size={20} />
              Enviar Mensaje
            </button>
