        ...
        <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-6">
          {feature.images.map((item, idx) => {
            ...
            return (
              <div
                key={idx}
                className="group relative overflow-hidden rounded-2xl shadow-lg hover:shadow-2xl transition-[box-shadow] duration-200 flex flex-col"
              >
                {/* Media container — altura fija para alinear todas las tarjetas */}
                ...
                {/* Caption — visible siempre, alineado al fondo */}
                {item.caption && (
