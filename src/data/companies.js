...
export const companiesData = [
  ...
  // ── EMPRESA 1: Centro de Capacitación ECG ──────────────────────────────────
  {
    id: 1,
    ...
    // Puedes usar URLs externas o rutas locales como '/assets/carousel/img1.jpg'
    carouselImages: [
    ...
    // ── Sección Inicio — Features (tarjetas con galería) ─────────────────────
    features: [
      {
        name: 'Experiencia',
  ...
  // ── EMPRESA 2: JECG Proyectos de Sustentabilidad ───────────────────────────
  {
    id: 2,
  ...
  // ── EMPRESA 3: Centro de Ingeniería y Abastecimiento ECG ───────────────────
  {
    id: 3,
